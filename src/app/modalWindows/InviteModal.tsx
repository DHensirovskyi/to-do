...
export default function InviteModal() {
  ...
  return (
    <>
        ...
        <section className="flex flex-col gap-4 rounded-lg bg-white">
          ...
          <div className="border-black/20 border p-4 flex flex-col gap-5">
            <div className='flex flex-col gap-1.5'>
               <p className="text-[1rem] font-semibold">Email</p>
                <form action="submit" className="flex flex-col sm:flex-row gap-2">
                  ...
                  />
                  <Button
                    className="bg-[#228be6] hover:bg-[#339af0] text-white font-medium whitespace-nowrap px-4"
            ...
            <div className='flex flex-col gap-3'>
                ...
                {users.map((user) => (
                  <div className='flex sm:flex-row flex-col justify-between items-center xl:gap-4 gap-2' key={user.img}>
      ...
      <button className="w-24 h-9 border border-[#228be6] rounded-[8px] p-[1rem] text-[#228be6] flex gap-1 active:scale-98 items-center justify-center cursor-pointer hover:bg-[#339af0] hover:text-white transition duration-200" onClick={open}>
          <IoPersonAddSharp />
